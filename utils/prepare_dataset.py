...
raw_data_path = None
raw_data_path_DRIVE = [raw_training_x_path_DRIVE,raw_training_y_path_DRIVE,raw_test_x_path_DRIVE,raw_test_y_path_DRIVE,raw_test_mask_path_DRIVE]
raw_data_path_CHASEDB1 = [raw_training_x_path_CHASEDB1,raw_training_y_path_CHASEDB1,raw_test_x_path_CHASEDB1,raw_test_y_path_CHASEDB1,raw_test_mask_path_CHASEDB1]
raw_data_path_STARE = [raw_training_x_path_STARE,raw_training_y_path_STARE,raw_test_x_path_STARE,raw_test_y_path_STARE,raw_test_mask_path_STARE]
